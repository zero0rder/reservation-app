...
const styles = {
  footer: `flex flex-col w-full px-12 sm:px-20 py-4 py-12 text-white min-h-40 bg-zinc-800`,
...
const AppFooter: React.FC<AppFooterProps> = () => {
  return (
    <footer className={styles.footer}>
      <div>
        <div className="flex">
          <div className="flex flex-col w-2/5 gap-y-6">
            ...
            <div>
              ...
              />
              <button className="w-24 p-2 ml-2 font-medium rounded-xl bg-sky-500">
                Email Me!
              </button>
            </div>
          </div>
          <div className="flex w-3/5 gap-x-12">
            <div>
